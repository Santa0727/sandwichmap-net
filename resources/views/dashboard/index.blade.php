    ...
    <div class="row" style="padding-top: 20px;">
        <div class="col-sm-12 col-md-6 col-lg-3 col-xl-3">
            <div class="card bg-success img-card box-success-shadow x-box-cards">
                <div class="card-body card-taps">
                    <a href="{{ route('dashboard_restaurant.index') }}"></a>
                    <div class="d-flex">
                        <div class="text-white">
                            ...
                            <div class="progress h-2" style="margin-top:20px">
                                <div class="progress-bar" role="progressbar" style="width: {{ ($Restaurants / 10000) * 100 }}%!important;background-color: #24dcc2"></div>
                            </div>
                ...
                <div class="card-body card-taps">
                    ...
                    <div class="d-flex">
                        <div class="text-white">
                            ...
                            <div class="progress h-2" style="margin-top:20px">
                                <div class="progress-bar" role="progressbar" style="width:{{ ($pro / 10000) * 100 }}%!important;background-color: #24dcc2"></div>
                            </div>
                            <span class="d-inline-block" style="color: #FFF">Target: 10000</span>
                        </div>
                ...
                <div class="card-body card-taps">
                    ...
                    <div class="d-flex">
                        <div class="text-white">
                            ...
                            <div class="progress h-2" style="margin-top:20px">
                                <div class="progress-bar w-50" role="progressbar" style="width:{{ ($users / 10000) * 100 }}%!important;background-color: #24dcc2"></div>
                            </div>
                            <span class="d-inline-block" style="color: #FFF">Target: 10000</span>
                        </div>
        ...
        <div class="col-sm-12 col-md-6 col-lg-3 col-xl-3">
            <div class="card bg-primary img-card box-primary-shadow x-box-cards">
                <div class="card-body card-taps">
                    <a href="{{ route('dashboard_orders.index') }}"></a>
                    <div class="d-flex">
                        <div class="text-white">
                            <h2 class="mb-0 number-font">{{ $orrder }}</h2>
                            <p class="mb-0 number-font custom-number">Total Sales</p>
                            <div class="progress  " style="margin-top:20px">
                                <div class="progress-bar" role="progressbar" style="width:{{ ($orrder / 100000) * 100 }}%!important;background-color: #24dcc2"></div>
                            </div>
        ...
        <div class="col-lg-6 col-md-12 col-sm-12 col-xl-3">
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        <div class="col">
                            <a href="{{ route('dashboard_orders.index') }}" style="text-decoration: none;color: #000">
                                <h6 class="">All Orders</h6>
                            </a>
                            <h3 class="mb-2 number-font">{{ $ordersCount->all }}</h3>
                            <p class="text-muted">
                                <span class="text-success"><i class="fa fa-chevron-circle-up text-success ml-1"></i> {{ $orrder }}%</span>
                                last month
                            </p>
                            <div class="progress h-2">
                                <div class="progress-bar bg-success" style="width:{{ $orrder_this_month }}%!important;" role="progressbar"></div>
                            </div>
                            <span class="d-inline-block mt-2 text-muted">{{ $orrder_this_month }}% increase</span>
                        </div>
                        <div class="col col-auto">
                            <a href="{{ route('dashboard_orders.index') }}">
        ...
        <div class="col-lg-6 col-md-12 col-sm-12 col-xl-3">
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        <div class="col">
                            <a href="{{ route('dashboard_orders.index', ['status' => 3]) }}" style="text-decoration: none;color: #000">
                                <h6 class="">Rejected Orders</h6>
                            </a>
                            <h3 class="mb-2 number-font">{{ $ordersCount->rejected }}</h3>
                            <p class="text-muted">
                                <span class="text-success"><i class="fa fa-chevron-circle-up text-success ml-1"></i> {{ $orrder_this_month3 }}%</span>
                                last month
                            </p>
                            <div class="progress h-2">
                                <div class="progress-bar bg-secondary" style="width:{{ $orrder_this_month3 }}%!important;" role="progressbar"></div>
                            </div>
                            <span class="d-inline-block mt-2 text-muted">{{ $orrder_this_month3 }}% increase</span>
                        </div>
                        <div class="col col-auto">
                            <a href="{{ route('dashboard_orders.index', ['status' => 3]) }}">
        ...
        <div class="col-lg-6 col-md-12 col-sm-12 col-xl-3">
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        <div class="col">
                            <a href="{{ route('dashboard_orders.index', ['status' => 5]) }}" style="text-decoration: none;color: #000">
                                <h6 class="">Accepted Orders</h6>
                            </a>
                            <h3 class="mb-2 number-font">{{ $ordersCount->accepted }}</h3>
                            <p class="text-muted">
                                <span class="text-success"><i class="fa fa-chevron-circle-up text-success ml-1"></i> {{ $orrder_this_month5 }}%</span>
                                last month
                            </p>
                            <div class="progress h-2">
                                <div class="progress-bar bg-info" style="width:{{ $orrder_this_month3 }}%!important;" role="progressbar"></div>
                            </div>
                            <span class="d-inline-block mt-2 text-muted">{{ $orrder_this_month5 }}% increase</span>
                        </div>
                        <div class="col col-auto">
                            <a href="{{ route('dashboard_orders.index', ['status' => 5]) }}">
        ...
        <div class="col-lg-6 col-md-12 col-sm-12 col-xl-3">
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        <div class="col">
                            <a href="{{ route('dashboard_orders.index', ['status' => 1]) }}" style="text-decoration: none;color: #000">
                                <h6 class="">Pending Orders</h6>
                            </a>
                            <h3 class="mb-2 number-font">{{ $ordersCount->pending }}</h3>
                            <p class="text-muted">
                                <span class="text-success"><i class="fa fa-chevron-circle-up text-success ml-1"></i> {{ $orrder_this_month1 }}%</span>
                                last month
                            </p>
                            <div class="progress h-2">
                                <div class="progress-bar bg-primary" style="width:{{ $orrder_this_month1 }}%!important;" role="progressbar"></div>
                            </div>
                            <span class="d-inline-block mt-2 text-muted">{{ $orrder_this_month1 }}% increase</span>
                        </div>
                        <div class="col col-auto">
                            <a href="{{ route('dashboard_orders.index', ['status' => 1]) }}">
        ...
        <div class="col-md-12 col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div>
                        <form method="post" action="{{ route('dashboard_restaurant.export') }}">
