        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="form-group">
                    <label>City</label>
                    <select multiple="single" name="city_id[]" id="city_id"
                            class="filter-multi">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="name"
                           id="name"
                           placeholder="Provide Restaurant Name">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="fees"
                           id="fees"
                           placeholder="Provide Restaurant Fees">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="delivery"
                           id="delivery"
                           placeholder="Provide Restaurant Delivery Time">
                </div>
            ...
            <div class="card-body">
                <div class="form-group">
                    ...
                    <input type="email" class="form-control" name="email"
                           id="email"
                           placeholder="Provide restaurant management email">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="password"
                           id="password"
                           placeholder="Provide restaurant management password">
                </div>
